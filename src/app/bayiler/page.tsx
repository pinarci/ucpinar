...
export default function DealersPage() {
  return (
    <>
      <PageIntro eyebrow="Bayi ağı" title="Size hizmet veren bayiyi bulun." description="Bireysel ev teslimatları ağırlıklı olarak Üçpınar bayileri üzerinden yapılır." />
